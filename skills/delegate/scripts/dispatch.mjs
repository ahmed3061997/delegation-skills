 ...
 *
 * Result: <out-dir>/result.json, schema delegate.run.v1, plus a summary on
...
export const RUN_SCHEMA = "delegate.run.v1";
...
function prepareRun(opts, brief) {
  ...
  const outDir =
    opts.outDir || join(tmpdir(), "delegate", `${basename(opts.cd) || "repo"}-${opts.agent}-${timestamp()}`);
