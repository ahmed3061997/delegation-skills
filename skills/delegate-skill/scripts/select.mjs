...
function main(argv) {
  ...
  if (opts.command === "agents") {
    ...
    process.stdout.write(
      opts.format === "text"
        ...
        : `${JSON.stringify({ schema: "delegate-skill.agent-choices.v1", stale: catalog.stale, staleReason: catalog.staleReason, agents: choices }, null, 2)}\n`,
    );
    return 0;
  }
  ...
  if (opts.command === "models") {
    ...
    process.stdout.write(
      opts.format === "text"
        ...
        : `${JSON.stringify({ schema: "delegate-skill.model-choices.v1", ...choices }, null, 2)}\n`,
    );
    return 0;
  }
  ...
  if (opts.command === "efforts") {
    ...
    process.stdout.write(
      opts.format === "text"
        ...
        : `${JSON.stringify({ schema: "delegate-skill.effort-choices.v1", ...choices }, null, 2)}\n`,
    );
    return 0;
  }
  ...
  if (opts.command === "resolve") {
    ...
    process.stdout.write(
      `${JSON.stringify({ schema: "delegate-skill.selection.v1", ...outcome.selection }, null, 2)}\n`,
    );
    return 0;
  }
